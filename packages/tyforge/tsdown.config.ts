...
export default defineConfig({
  entry: {
    ...
    "config/tyforge-config.browser": "src/config/tyforge-config.browser.ts",
    "tools/network-security.browser": "src/tools/network-security.browser.ts",
    "infrastructure/service.base.browser": "src/infrastructure/service.base.browser.ts",
  },
  format: "esm",
  dts: true,
  clean: true,
