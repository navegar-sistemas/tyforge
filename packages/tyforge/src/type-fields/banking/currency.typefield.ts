import { TypeField, TFormatTarget } from "@tyforge/type-fields/_base/type-field.base";
...
export class FCurrency extends FMoney {
  ...
  static validateType(value: unknown, fieldPath = "Currency"): Result<TCurrency, ExceptionValidation> {
