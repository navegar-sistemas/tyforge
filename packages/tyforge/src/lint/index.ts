...
import { NoInvalidFactorySignatureRule } from "./rules/no-invalid-factory-signature.rule";
import { NoPublicConstructorDomainRule } from "./rules/no-public-constructor-domain.rule";
