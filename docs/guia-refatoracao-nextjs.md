# Guia de Refatoração: Next.js com TyForge

> Guia completo para refatorar projetos Next.js aplicando Clean Architecture, Clean Code e SOLID usando TyForge como base de padrões.

---

## Visão Geral

TyForge é uma biblioteca TypeScript que fornece building blocks para DDD (Domain-Driven Design), validação type-safe e Result pattern. Este guia mostra como estruturar um projeto Next.js de nível empresarial usando TyForge para impor padrões de código.
